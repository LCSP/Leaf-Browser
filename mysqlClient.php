...
$ACCESS_PWD='amarillo12'; #!!!IMPORTANT!!! this is script access password, SET IT if you want to protect you DB from public access

#DEFAULT db connection settings
# --- WARNING! --- if you set defaults - it's recommended to set $ACCESS_PWD to protect your db!
$DBDEF=array(
'user'=>"gamarrat_wordpre",#required
'pwd'=>"g4m4rr42222", #required
'db'=>"gamarrat_wordpress",  #optional, default DB
